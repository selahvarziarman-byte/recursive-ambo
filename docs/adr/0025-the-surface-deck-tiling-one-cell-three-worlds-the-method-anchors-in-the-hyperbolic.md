...
★ **PORT (designer, ratified): when the inhabited register is built, *"the world comes back"* ALREADY has its sentence — rung 1's `back where you started · N doors`, specced/built/accepted at Arman's hand.** Reuse it; do not author a second sentence for a fact that already has one.
