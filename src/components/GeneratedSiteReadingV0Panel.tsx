    ...
    <section className="grid gap-3">
      ...
      <details className="rounded border border-stone-800 bg-stone-950/75 px-3 py-3 text-xs">
        ...
        <section className="mt-3 rounded border border-emerald-400/20 bg-emerald-950/10 px-3 py-3">
          <p className="mb-3 rounded border border-amber-300/25 bg-amber-300/10 px-3 py-2 leading-5 text-amber-100">
            This legacy section is retained for diagnostic comparison only. It
            is not the authoritative FieldCue evidence display and must not be
            read as generated-site meaning.
          </p>
          <header className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <h3 className="text-xs font-semibold uppercase tracking-[0.14em] text-emerald-100">
                Legacy generated-site reading diagnostics
              </h3>
              <p className="mt-1 leading-5 text-stone-400">
                Choose a generated midpoint and inspect legacy diagnostic
                questions for comparison only.
              </p>
            </div>
            <span
